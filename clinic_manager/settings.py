...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-wr+_z+#2d-uk2dqks86s)t8pe43-41!fa4(bmx@v5vt9s=fcg(')
...
INSTALLED_APPS = [
    ...
    'leads.apps.LeadsConfig',  # Register the leads app
]
...
if DB_HOST:
    ...
    # Fallback to SQLite for easier local development/testing when database env is not configured
    DATABASES = {
        'default': {
